...
2020년 한 취업포털에서 취업준비생을 대상으로 취업준비 현황을 조사한 결과 응답자의 23.8 "IT인터넷" 업계의 취업을 준비한다는 결과가 나왔으며 이는 취업준비생들이 전공에 상관없이 공통적으로 "IT인터넷" 업계에 관심이 높으며 종사를 희망하는 사람들이 증가하는 추세임을 알 수 있었다. 이를 바탕으로  IT분야에서도 특히 개발자를 희망하는 사람들이 소통하며 취업 준비를 할 수 있는 사이트를 만들어 IT분야의 다양한 정보들을 한 곳에서 많은 사람들과 공유할 수 있게 하는 것이 ITEACH의 개발 목적이다.
